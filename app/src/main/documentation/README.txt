{
  ...
  "visual_language": {
    ...
    "three_post_one_body_border_rule_language": {
      ...
      "state_paths": {
        ...
        "main_posts.star": "three_post_one_body.main_posts.star.border_rule"
      },
      "rule_shape": {
  ...
  "post_state_terms": {
    "non_star": {
      ...
      "selector": "#mainPosts article.post.post-state-not-star"
    },
    "star": {
      "display_name": "Star Main Post",
      "description": "A Star published Main Post. Border timing and timestamp presentation live in the same canonical state block.",
      "configuration": "config.json -> three_post_one_body.main_posts.star",
      "selector": "#mainPosts article.post.post-state-star"
    },
    "super_star": {
      "display_name": "Super Star Top Post",
      ...
      "configuration": "config.json -> three_post_one_body.top_post.super_star",
  ...
  "configuration_terms": {
    ...
    "new_post_text_area_height": {
      "code_location": [
        "app/src/main/assets/config/config.json + app/src/main/assets/config/anim.json",
  ...
  "ui_string_storage_rule": {
    "english": "User-visible wording belongs in assets/language/English.json. assets/language/jet_note_ui_language.json documents canonical UI terminology and architecture; config.json is reserved for geometry, colors, behavior, action identifiers, asset paths, URLs, and other non-language configuration."
  },
  "interaction_rules": {
