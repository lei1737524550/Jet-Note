...
const DEFAULT_POSTS = [
  {
    id: 1,
    text: "there's a catch = 但有个问题 / 但有个坑 / 事情没那么简单\n\n○  catch 在这里指一个隐藏的问题、限制或不利条件。",
    time: "今天10:09"
  },
  {
    id: 2,
    text: "smear — 最贴近“抹黑、诋毁”，尤其指故意损害某人的名誉。\na smear campaign = 抹黑行动 / 诋毁攻势",
    time: "今天08:49"
  }
];
...
function getDisplayName() {
  ...
  return el ? el.textContent.trim() : 'ingenious idea';
}
