...
final class MediaDownloadController {
    ...
    static void saveUrls(Activity activity, List<String> urls, String mediaType, String userAgent, String cookie, String referer) {
        FileTaskManager.downloadUrls(activity, urls, mediaType, userAgent, cookie, referer);
    }
